      ...
      for (var j = 0; j < usersList[i]?.length; j++) {
        ...
        $("#tableUsers").append(
          "<tr>" +
            ...
            "" +
            "<td contenteditable='true'>" +
            getUserType(users.type) +
            "</td>" +
            "" +
            "<td>" +
            "<button class='btn btn-primary' type='button' onclick='editUser(\"#tableUsers\")'>Actualizar</button> " +
            "</td>" +
            "<td>" +
            "<button class='btn btn-primary' type='button' onclick='deleteTableElement(\"#tableUsers\")'>Eliminar</button> " +
            "</td>" +
            "</tr>"
        );
      }
