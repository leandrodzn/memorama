      ...
      for (var j = 0; j < matters[i]?.length; j++) {
        $("#tableMatters").append(
          "<tr>" +
            ...
            "" +
            "<td>" +
            "<button class='btn btn-primary' type='button' onclick='editMatter(\"#tableMatters\")'>Actualizar</button> " +
            "</td>" +
            "<td>" +
            "<button class='btn btn-primary' type='button' onclick='deleteTableElement(\"#tableMatters\")'>Eliminar</button> " +
            "</td>" +
            "<td>" +
            "<a class='btn btn-primary' type='button' href=../core/php/DownloadScores.php?idMatter=" +
            matters[i][j].id +
            " >" +
